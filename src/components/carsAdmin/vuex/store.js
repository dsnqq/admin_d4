...
export default {
    ...
    actions: {
        GET_CARS_FROM_API({commit}, param) {
            return axios.post(
                DOMAIN_API + '/index.php?route=api/auto/cars',
                {
                    key: KEYS,
                    page: param,
                }
        ...
        GET_CARS_TOTALS_FROM_API({commit}) {
            return  axios.post(
                DOMAIN_API + '/index.php?route=api/auto/cars/total',
                {
                    key: KEYS,
                }
            )
        ...
        GET_MARKA_FROM_API({commit}) {
            return axios.post(
                DOMAIN_API + '/index.php?route=api/auto/cars/marka',
                {
                    key: KEYS,
                }
            )
        ...
        GET_MODEL_FROM_API({commit}, marka) {
            return axios.post(
                DOMAIN_API + '/index.php?route=api/auto/cars/model',
                {
                    marka: marka,
                    key: KEYS,
                }
        ...
        GET_CAR_FROM_API({commit}, car_id) {
            return axios.post(
                DOMAIN_API + '/index.php?route=api/auto/cars/' + car_id,
                {
                    key: KEYS,
                }
            )
        ...
        SET_CAR_FROM_API({commit}, param) {
            return axios.post(
                DOMAIN_API + '/index.php?route=api/auto/cars/create',
                param
            )
                .then(() => {
        ...
        DELET_CAR_BY_API({commit}, param) {
            return axios.post(
                DOMAIN_API + '/index.php?route=api/auto/cars/' + param.carId + '/delete',
                {
                    key: KEYS,
                }
            )
