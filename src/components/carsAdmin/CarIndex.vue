<template>
  <div>
    <Breadcrumb>
      <template #buttons>
        <router-link :to="{ name: 'carsAdmin' }" class="btn btn-primary">
          Выйти
        </router-link>
      </template>
    </Breadcrumb>
        ...
        <form>
          <div class="car-index__wrapp car-index-wrapp">
            <div
              ...
              :key="fieldItem.id"
              :class="{
                'car-index-wrapp__field car-index-field': fieldItem.index,
              }"
            >
                ...
                <div class="car-index-field__wrap">
                  ...
                  <template v-else-if="fieldItem.type === 'select'">
                    <v-multiselect
                      ...
                      :deselect-label="`Клик, чтобы удалить`"
                      :select-label="`Клик, чтобы выбрать`"
                      :placeholder="fieldItem.name"
            ...
            <div
              class="car-index-wrapp__field car-index-field car-index-field--is-btn"
            >
              <button
                v-if="isCreatedPage"
              ...
              <router-link :to="{ name: 'carsAdmin' }" class="btn btn-info">
...
export default {
  ...
  computed: {
    ...mapGetters('carAdmin', ['CAR', 'MARKA', 'MODEL']),
